...
$friend_pictureUrl = trim($_GET['friend_pictureUrl']);
$friend_name = trim($_GET['friend_name']);
/*
$userid = '100000399544716';
$user_pictureUrl = 'https://profile.ak.fbcdn.net/hprofile-ak-ash3/c0.9.240.311/s200x200/29589_519065191450128_43316702_n.jpg';
$friend_id = '1263285072444';
$friend_pictureUrl = 'https://profile.ak.fbcdn.net/hprofile-ak-prn2/t1/c0.0.612.794/s200x200/1484199_10201309967292199_2095278675_n.jpg';
$user_name = 'sasasa';
$friend_name = 'aaaaaaaaaaaa';
...
//}
   ...
   // $photo_details['url']           = $image_absolute_url;                        # Use this to upload image using an Absolute URL.
    $photo_details['message']       = 'Find your salsa partner https://apps.facebook.com/salsapartner';
    $photo_details['tags']          =  array(
                                          array(
                                            'tag_uid'=> $friend_id,
                                                 'x'      => 0,
                                                    'y'      => 0
	...
	unlink("{$userid}.jpg");   //delete  saved photo
